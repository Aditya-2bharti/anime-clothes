  ...
  <div className="container px-5 py-10 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">AnimeClothes</h2>
        ...
        <div className="flex">
          ...
          <button onClick={ ()=>{toast('Your item is in Shoping Cart', {
            position: "top-right",
            autoClose: 2000,
            hideProgressBar: false,
            closeOnClick: true,
            pauseOnHover: true,
            draggable: true,
            progress: undefined,});  addToCart(slug, 1, product.price, product.title, size, color)}} className="flex  ml-8 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add To Cart</button>
          <button onClick={()=>{buyNow(slug, 1, product.price, product.title, size, color)}} className="flex  ml-6 text-white bg-pink-500 border-0 py-2 px-1 text-sm md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
        ...
        <div className='pin mt-6 flex space-x-2 text-sm'>
            <input onChange={onChangepin} type="text"  placeholder='Enter Your Pincode' className='px-2 border-2 border-pink-300  rounded-md'/>
